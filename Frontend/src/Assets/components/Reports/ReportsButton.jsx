...
const ReportsButton = ({ selectedButton, setSelectedButton }) => {
  return (
    <div className="bg-[rgba(16,16,16,0.6)] md:w-[20%] md:h-[92%] md:m-8 rounded-lg border border-white backdrop-blur-sm justify-center items-center mt-8 grid grid-cols-2 md:grid-row gap-4 md:gap-0 p-4 m-6 md:p-0 md:grid-cols-none">
      {" "}
      <button
      ...
      >
        <img src={Average} className="w-6 h-6 mt-4 md:h-auto md:mt-0" />
      ...
      >
        <img src={Interval} className="w-6 h-6 mt-4 md:h-auto md:mt-0" />
      ...
      >
        <img src={Dateimg} className="w-6 h-6 mt-4 md:h-auto md:mt-0" />
      ...
      >
        <img src={Count} className="w-6 h-6 mt-4 md:h-auto md:mt-0" />

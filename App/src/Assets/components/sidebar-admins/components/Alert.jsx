  ...
  return (
    <div className="flex flex-col w-full h-full">
      <div className="flex flex-col flex-1 gap-4 px-4 py-4">
        <div className="h-[60%] rounded-2xl bg-[#101010]/90 backdrop-blur-sm border-2 border-white">
        ...
        <div className="h-[40%] w-full rounded-2xl bg-[#101010]/90 backdrop-blur-sm">
          <div className="flex h-[14%] items-center justify-between px-6">
            <div className="mt-4 justify-start font-['Poppins'] text-2xl font-semibold text-white">
            Select Mode
            </div>
          </div>
          <div className="flex h-[25%] flex-col items-center justify-center overflow-hidden px-6 py-4">

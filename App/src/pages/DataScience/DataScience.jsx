...
import Switcher10 from "../../Assets/components/DataScience/Switcher10";
import Switcher9 from "../../Assets/components/DataScience/Switcher9";
import DataScienceTable from "../../Assets/components/DataScience/DataScienceTable";
  ...
  return (
    ...
    >
      ...
      <div className="flex  bg-[rgba(16,16,16,0.75)] h-[840px] md:h-[87%] m-4 rounded-lg border border-white flex-col text-white">
        ...
        <div className="md:h-[65%] h-[504px] flexmd:w-full rounded-br-lg rounded-bl-lg  overflow-x-auto overflow-y-auto  slimscroll-custom">
          <DataScienceTable/>
        </div>
      </div>
    </div>
